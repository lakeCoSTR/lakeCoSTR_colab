...
You must have [Google Account](https://support.google.com/accounts/answer/27441?hl=en){:target="_blank"} and [Google Earth Engine Credentials](https://signup.earthengine.google.com/){:target="_blank"} in order to use this tool.

lakeCoSTR is an open-source tool, but please cite accordingly - the widget provided on the right side of the [repository landing page](https://github.com/lakeCoSTR/lakeCoSTR_colab){:target="_blank"} will provide a citation. 
...
__lakeCoSTR works best for small lakes__
 - small lakes are usually completely contained within one or more [WRS-2 path rows](https://landsat.gsfc.nasa.gov/about/the-worldwide-reference-system/){:target="_blank"}. lakeCoSTR does not aggregate data between multiple Landsat path-rows. Users will be messaged in the tool if there are issues with this
...
Visit the [Colab Basics](https://colab.research.google.com/){:target="_blank"} webpage and run through the script that pops up on this page. It will walk your through how to use a Colab Notebook!
...
c) navigate to [the Colab browser](https://colab.research.google.com/){:target="_blank"}
